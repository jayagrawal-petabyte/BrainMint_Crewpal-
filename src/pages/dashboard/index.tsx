    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          {statistics && (
            <SectionErrorBoundary title="Statistics" onRetry={() => void refresh()}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <SectionErrorBoundary title={t.assignedTasks} onRetry={() => void refresh()}>
                <AssignedTasksWidget
                  tasks={assignedTasks}
              ...
              <SectionErrorBoundary title={t.projectProgress} onRetry={() => void refresh()}>
              ...
              <SectionErrorBoundary title={t.recentActivity} onRetry={() => void refresh()}>
            ...
            <div className="space-y-6">
              ...
              <SectionErrorBoundary title={t.upcomingDeadlines} onRetry={() => void refresh()}>
                <UpcomingDeadlines
                  deadlines={deadlines}
              ...
              <SectionErrorBoundary title={t.todaySchedule} onRetry={() => void refresh()}>
                <TodaySchedule 
                  items={schedule} 
              ...
              {/* Quick Actions */}
              <SectionErrorBoundary title={t.quickActions} onRetry={() => void refresh()}>
