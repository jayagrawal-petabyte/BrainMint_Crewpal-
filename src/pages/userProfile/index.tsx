...
export const UserProfile = () => {
  ...
  const user = USERS.find((member) => member.id === Number(id));
  ...
  return (
    <div className="px-10 py-8">
      <div className="max-w-5xl mx-auto">
        <div className="bg-[#E6E9C8] rounded-[32px] p-8 shadow-sm">
          ...
          <div className="bg-[#F9E8DE] rounded-3xl p-7 flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[#0D556D] mt-1">{user.designation}</p>
            </div>
          </div>
          ...
          <div className="bg-[#F9E8DE] rounded-3xl mt-6 p-8">
            ...
            <div className="grid grid-cols-2 gap-x-16 gap-y-3">
              <div>
                ...
                <div className="mt-5">
                  <p className="font-semibold">Project Allocated:</p>
