  ...
  return (
    <div className="min-h-screen bg-[#f5f0e1] px-4 pt-6 pb-24 max-w-lg mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-extrabold text-forest-900 tracking-tight">Settings</h1>
          <p className="text-xs text-forest-500 mt-0.5">Manage your preferences</p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="space-y-5">
        ...
        <SectionCard title="Notification Preferences">
          <PrefRow
            ...
            description="Silence all alerts across all channels"
            enabled={muteAll}
          ...
          <PrefRow
            ...
            description="Notification bell inside the app"
          ...
          <PrefRow
            icon={Bell}
            label="Sprint Alerts"
            description="Alerts when sprints start, end or change"
        ...
        <SectionCard title="Language & Region">
          <div className="px-5 py-4">
            <p className="text-sm font-semibold text-forest-900 mb-1">Display Language</p>
            <p className="text-xs text-forest-500 mb-3">Choose the language for the app interface</p>
        ...
        <SectionCard title="Appearance">
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <p className="text-sm font-semibold text-forest-900">Dark Mode</p>
                <p className="text-xs text-forest-500 mt-0.5">Switch between light and dark theme</p>
              </div>
            </div>
